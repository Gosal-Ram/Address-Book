                    ...
                    <div class="modal-body">
                        <form method = "POST">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="uploadExcel" name="uploadExcel" accept=".xlsx, .xls" required>
                            </div>
                        
                        <cfif structKeyExists(form, "uploadSubmitBtn")>
                          <cfset excelUploadResult = application.obj.retrieveExcelData(
                            excelFile = form.uploadExcel
                          )>
                          <div class="d-flex justify-content-start"> 
                            <span class="text-success fw-bold ms-5 fs-6" id="uploadResult">#excelUploadResult#</span> 
                          </div>
                        </cfif>
